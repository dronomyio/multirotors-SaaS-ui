...
export const getCreateDraftOrderUrl = (id: number,) => {




  return `/api/openai/conversations/${id}/draft-order`
}

/**
 * @summary Create a Shopify draft order from an accepted AI invoice
 */
export const createDraftOrder = async (id: number,
    draftOrderInput: DraftOrderInput, options?: Parameters<typeof customFetch>[1]): Promise<DraftOrderResult> => {

  return customFetch<DraftOrderResult>(getCreateDraftOrderUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCreateDraftOrderMutationOptions = <TError = ErrorType<OpenaiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createDraftOrder>>, TError,{id: number;data: BodyType<DraftOrderInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createDraftOrder>>, TError,{id: number;data: BodyType<DraftOrderInput>}, TContext> => {

const mutationKey = ['createDraftOrder'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createDraftOrder>>, {id: number;data: BodyType<DraftOrderInput>}> = (props) => {
          const {id,data} = props ?? {};

          return  createDraftOrder(id,data,requestOptions)
        }
 ...
 * @summary Create a Shopify draft order from an accepted AI invoice
 */
export const useCreateDraftOrder = <TError = ErrorType<OpenaiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createDraftOrder>>, TError,{id: number;data: BodyType<DraftOrderInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createDraftOrder>>,
        TError,
        {id: number;data: BodyType<DraftOrderInput>},
        TContext
      > => {
      return useMutation(getCreateDraftOrderMutationOptions(options));
    }
